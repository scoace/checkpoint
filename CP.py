...
class CP:
    ...
    def get_hosts(self):
            ...
            for x in range(100):  # max 5000 hosts
                ...
                offset = x*500
                response = self.client.api_call("show-hosts", {"limit": 500,  "offset": offset,  "details-level" : "standard" } )
    ...
    def get_networks(self):
        ...
        for x in range(100):  # max 5000 hosts
            ...
            offset = x*500
            response = self.client.api_call("show-networks", {"limit": 500,  "offset": offset,  "details-level" : "standard" } )
    ...
    def get_services_tcp(self):
        ...
        for x in range(100):  # max 5000 hosts
            ...
            offset = x*500
            response = self.client.api_call("show-services-tcp", {"limit": 500,  "offset": offset,  "details-level" : "standard" } )
    ...
    def get_tcp_services_dict(self):
        ...
        for service in mylist:
            ...
            service_data = {"name": service["name"], "uid": service["uid"],"port": service["port"]}
